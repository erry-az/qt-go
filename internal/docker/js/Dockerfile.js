...
RUN /usr/local/go/bin/go get -tags=no_env github.com/erry-az/qt-go/cmd/...
...
COPY --from=base $GOPATH/src/github.com/erry-az/qt-go $GOPATH/src/github.com/erry-az/qt-go
...
RUN cd $GOPATH/src/github.com/erry-az/qt-go/internal/examples/widgets/line_edits && $GOPATH/bin/qtdeploy build js && rm -rf ./deploy
