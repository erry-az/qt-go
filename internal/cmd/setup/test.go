...
import (
	...
	"github.com/erry-az/qt-go/internal/binding/templater"

	"github.com/erry-az/qt-go/internal/cmd"
	"github.com/erry-az/qt-go/internal/cmd/deploy"
	"github.com/erry-az/qt-go/internal/cmd/minimal"
	"github.com/erry-az/qt-go/internal/cmd/moc"
	"github.com/erry-az/qt-go/internal/cmd/rcc"
...
func Test(target string, docker, vagrant bool, vagrantsystem string) {
	...
	for cat, list := range examples {
		for _, example := range list {
			...
			path := filepath.Join(strings.TrimSpace(utils.GoListOptional("{{.Dir}}", "github.com/erry-az/qt-go/internal/examples", "-find", "get doc dir")), example)
