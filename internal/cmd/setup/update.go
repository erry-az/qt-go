...
func Update() {
	...
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/erry-az/qt-go/cmd/..."), "run \"go clean cmd\"")
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/erry-az/qt-go/internal/..."), "run \"go clean internal\"")
	...
	utils.RunCmd(exec.Command("go", "install", "-v", fmt.Sprintf("-ldflags=\"-X=github.com/erry-az/qt-go/internal/cmd.buildVersion=%v\"", hash), fmt.Sprintf("github.com/erry-az/qt-go/cmd/...")), "run \"go install\"")
...
func Upgrade() {
	...
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/erry-az/qt-go/..."), "run \"go clean\"")
	utils.RemoveAll(utils.GoQtPkgPath())

	utils.RunCmd(exec.Command("go", "get", "-v", "-d", "github.com/erry-az/qt-go/cmd/..."), "run \"go get\"")
